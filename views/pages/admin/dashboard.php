  ...
  <div class="row mb-4 g-4">
    ...
    <div class="col-md-6">
      <div class="card p-4 shadow-sm border-0 rounded-3 h-100 bg-white d-flex flex-row align-items-center justify-content-between">
        ...
        <div class="text-end">
          <span class="text-secondary mb-1 d-block">Tenaga Kerja Aktif</span>
          <h2 class="fw-bold text-success mb-0" style="font-size:2.5rem;"><?= $totalActiveWorkers ?? 0 ?></h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row g-4">
    <div class="col-md-6">
      <div class="card p-3 shadow-sm border-0 rounded-3 bg-white">
        <h5 class="mb-3 text-primary text-center">Jumlah Proyek</h5>
        <div>
    ...
    <div class="col-md-6">
      <div class="card p-3 shadow-sm border-0 rounded-3 bg-white align-items-center">
        <h5 class="mb-3 text-success text-center">Persentase Proyek per Mandor</h5>
        <div>
          <canvas id="mandorChart"></canvas>
        </div>
      </div>
    </div>
  </div>
...
<script>
  ...
  const ctx2 = document.getElementById('mandorChart').getContext('2d');
  new Chart(ctx2, {
    type: 'pie',
    data: {
